...
// 1. What is "this" when joe.scope() is invoked? the info inside the Student constructor
//
// 2. What is "this" when joe.scopeArrow() is invoked? it took the global window
//
// 3. Explain why "this" is different when an arrow function is used. because the arrow takes (this) value as the value in the surrounding functional scope, and there is no surrounding function available
//
